...
<%@include file="./server/module/auth.jsp"%>
			<html>
			...
			<body>
				<div>
					...
					<div class="pull-right" id="btnAction">
						<!--按钮部分，注释掉-->
						<div class="btn-toolbar" id="topMenuButton">
				...
				<div style="display:none">
                    <div class="FWRES" APPID="htmledit" RESID="topMenuButton">
                        <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-primary pull-right">
									<li>
										<a href="javascript:void(0)" onclick="FireEvent('htmledit.preview')"><i class="icon-edit"></i>直接预览</a>
									</li>
                                    <li>
										<a href="javascript:void(0)" onclick="FireEvent('htmledit.previewMoke')"><i class="icon-edit"></i>模拟预览</a>
									</li>
								</ul>
						</div>
                    </div>
                    <div class="FWRES" APPID="htmledit" RESID="sceneselect">
                        <div >
								<h1>请输入你要建立的新场景</h1>
                                场景标识:<input type="text"  style="width:100%;height:50px" id="moke_sig"/><br/>
                                url参数:<input type="text"  style="width:100%;height:50px" id="moke_qstr"/><br/>
                                注意：url参数不要带?比如a=4&r=iii<br/>
                                说明：选择完后，第一次是不会有结果的，请选择查看数据，去到编辑页面编辑新场景的模拟数据
                                <br/>
                                <br/>
                                <div style="TEXT-ALIGN: center;">
                                  <a href="javascript:void(0)" onclick="var sig = $('#moke_sig').val();var qstr=$('#moke_qstr').val();FireEvent.previewOneMoke(sig,qstr);" class="btn btn-info">
                                  ...
                                  <a href="javascript:void(0)" onclick="FW.unblockUI();" class="btn btn-warning">
                                  <i class="icon-ok bigger-110"></i>
                                  取消
                                  </a>
                                </div>
                    ...
                    <div class="FWRES" APPID="htmledit"  RESID="mokeMgr">
                          <div class="page-header position-relative textctrclose">
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <a href="#" onclick="FireEvent.newMokeMask();">新场景</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </div>
                          <table style="width:100%">
                            <tr >
                                <td style="width:20%;" valign="top">
                                <!--$for (var i=0;i<data.length;i++){-->
                                <a href="#" onclick="FireEvent.showOneMoke('${_}{data[i]}')">${_}{data[i]}</a><br/>
                                <!--$}-->
                                </td>
                                <td style="width:80%;"   id="onemoke">
                                </td>
                            </tr>
                          </table>
                    </div>
                    <div class="FWRES" APPID="htmledit"  RESID="onemoke">
                          <div class="page-header position-relative textctrclose">
                          场景标识:${_}{data.sig} &nbsp;&nbsp;&nbsp;
                          场景名:${_}{data.obj.evn.name || "无"}&nbsp;&nbsp;&nbsp;
                          <a href="#" onclick="FireEvent.previewOneMoke('${_}{data.sig}','${_}{data.obj.evn.qstr}');">预览</a>&nbsp;&nbsp;&nbsp;
                          <a href="#" onclick="FireEvent.saveOneMoke('${_}{data.sig}');">保存</a>
                          </div>
                          <textarea style="width:100%;height:600px;" id="mokeText">${_}{data.text}</textarea>
                    </div>
